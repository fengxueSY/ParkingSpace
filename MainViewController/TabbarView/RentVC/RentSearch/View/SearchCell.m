...
-(id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier{
    ...
    if (self) {
        ...
        _timeLabel = [CreatUI creatLabelWithFrame:CGRectMake(w / 32, CGRectGetMaxY(_addressLabel.frame), w * 23 / 32, h * 2 / 6) Text:nil  TextFont:14 BackgroudColor:nil TextColor:RGBcolor(150, 150, 150, 1)];
        _timeLabel.font = [UIFont systemFontOfSize:15];
        [self.contentView addSubview:_timeLabel];
        
        _startButton = [CreatUI creatButtonWithTitle:@"从这里找" TitleColor:[UIColor blueColor] Frame:CGRectMake(w * 25 / 32, h / 9, w * 6 / 32, h / 3) SetMasks:YES SetCorner:5 BackgroudColor:[UIColor clearColor] BackgroudImage:nil];
