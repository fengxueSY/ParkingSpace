...
//测试服务器地址以及名字，由后台提供
NSString * const bucketName = @"mybucket222";
NSString * const STSServer = @"http://120.24.89.166:8080/hoho/api/oss/sts";
 ...
 *	@return
 */
- (OSSFederationToken *) getFederationToken:(NSDictionary *)tokenDic {
...
- (void)ossInit:(NSDictionary *)tokenDic {
    id<OSSCredentialProvider> credential = [[OSSFederationCredentialProvider alloc] initWithFederationTokenGetter:^OSSFederationToken * {
        return [self getFederationToken:tokenDic];
    }];
